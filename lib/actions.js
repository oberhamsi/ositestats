...
var {renderResponse, getTemplate} = require("reinhardt");
...
exports.index = {
   GET: function(req) {
      ...
      return renderResponse('dashboard.html', {
...
exports.stats = function(req, siteKey, timeKey) {
   ...
   return renderResponse('stats.html', {
      site: siteKey,
      duration: duration,
      pageTimeKey: timeKey,
      ...
      'aggregates': {
         ...
         monthly: aggregatedata(siteKey, timeKey.substring(0,4)),
      },
      'distributions': [
         {
            key: 'referer',
            data: distributiondata(siteKey, 'referer', timeKey)
         },
         {
            key: 'userAgent',
            data: distributiondata(siteKey, 'userAgent', timeKey),
         },
         {
            key: 'page',
            data: distributiondata(siteKey, 'page', timeKey)
         },
         {
            key: 'age',
            data: distributiondata(siteKey, 'age', timeKey)
         }
      ]
   });
};
...
var distributiondata = exports.distributiondata = function(siteKey, distributionKey, timeKey) {
   ...
   var dists = JSON.parse(distributions[0].distributions);
   var result = [];
